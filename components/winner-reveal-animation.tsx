        ...
        {!isRevealed ? (
          ...
          >
            ...
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-2xl rounded-full px-12 py-8 text-2xl font-black group transition-all hover:scale-105 active:scale-95"
            >
