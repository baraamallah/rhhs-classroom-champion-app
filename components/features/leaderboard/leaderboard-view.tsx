        ...
        <div className="container mx-auto px-4 pt-10 pb-6 relative overflow-hidden">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-semibold mb-5 shadow-2xs">
              ...
              <span className="text-center">Official School Sustainability Competition</span>
            </div>
          ...
          {calculationMode ? (
            ...
            <Tabs defaultValue="Pre-School" className="w-full max-w-4xl mx-auto mb-16 relative z-10">
              ...
              <div className="sticky top-(--app-header-height) z-40 -mx-4 px-4 pb-3 pt-2 bg-background/80 dark:bg-background/85 backdrop-blur-md border-b border-border/40 mb-6 transition-all duration-200">
                <div className="relative max-w-4xl mx-auto">
                  <div className="flex justify-start sm:justify-center overflow-x-auto pb-1 no-scrollbar snap-x snap-mandatory scroll-smooth">
                    <TabsList className="inline-flex h-auto p-1 bg-muted/60 dark:bg-card/70 backdrop-blur-sm rounded-full border border-border/60 shadow-xs min-w-max gap-1">
