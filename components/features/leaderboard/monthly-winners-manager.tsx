...
export function MonthlyWinnersManager() {
  return useMonthlyWinnersManagerContent()
}

function useMonthlyWinnersManagerContent() {
  ...
  const loadTopClassrooms = useCallback(async () => {
    ...
    try {
      const results = await Promise.all(DIVISIONS.map(async (division) => ({
        division,
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          ...
                          >
                            ...
                            <SelectContent>
                              {classrooms
                                .filter((classroom) => classroom.division === division)
                                .map((classroom) => (
