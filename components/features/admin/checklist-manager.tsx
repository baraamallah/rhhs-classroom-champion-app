...
export function ChecklistManager({ currentUser }: ChecklistManagerProps) {
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        badge="Scoring Standards"
        badgeLabel="Inspection Rubrics & Criteria"
        title="Checklist Rubrics"
        description="Define evaluation criteria, point values, and category guidelines for campus inspections."
        action={
