        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {filteredClassrooms.map((classroom, index) => (
            ...
            >
              <Button
                variant="outline"
                className="w-full h-auto p-4 sm:p-5 flex flex-col items-start hover:bg-primary/10 hover:border-primary/70 transition-[background-color,border-color,color,box-shadow,opacity,transform] bg-card text-left whitespace-normal shadow-sm hover:shadow-md group"
