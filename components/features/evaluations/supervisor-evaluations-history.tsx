            ...
            <div className="space-y-3">
              {evaluations.map((evaluation, index) => (
                <m.div
                  ...
                  className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-5 rounded-lg border bg-card hover:bg-accent/5 transition-[background-color,border-color,color,box-shadow,opacity,transform] gap-4 shadow-sm hover:shadow-md"
                >
