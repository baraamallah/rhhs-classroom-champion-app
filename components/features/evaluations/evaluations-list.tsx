...
export function EvaluationsList() {
  ...
  const filteredEvaluations = scopedList.filter((e) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <CardHeader className="bg-muted/20 pb-4 border-b border-border/60">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <CardDescription className="text-xs sm:text-sm">
              Review, filter, and inspect all inspection scores and supervisor logs.
            </CardDescription>
          </div>
          ...
          <div className="space-y-2.5">
            {filteredEvaluations.map((evaluation) => {
              ...
              return (
                <div
                  key={evaluation.id}
                  className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl bg-card border border-border/80 hover:border-primary/40 transition-all gap-3 shadow-2xs"
                >
